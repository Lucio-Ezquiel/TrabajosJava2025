...
public class GestionEstudiantes {
    ...
    public static double calcularNotaMedia(Map<String, Integer> estudiantes) {
        ...
        return suma / estudiantes.size(); // Error semántico: División entera (calcularNotaMedia devuelve un double pero la division del return devuelve un int al ser los dos int)
    }
}
